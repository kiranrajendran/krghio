...
public boolean processRow(StepMetaInterface smi, StepDataInterface sdi) throws KettleException {
    ...
    r[index++] = item.getStringSet("server_name");;
    r[index++] = item.getStringSet("DB_HOST");
    r[index++] = item.getStringSet("DB_PORT");;
    r[index++] = item.getStringSet("DB_SCHEMA");;
    r[index++] = item.getStringSet("DB_USER");;
    r[index++] = item.getStringSet("DB_PASS");;
